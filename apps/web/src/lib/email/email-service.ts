...
export function renderVerificationEmailHtml(name: string, verificationUrl: string): string {
  return `
...
export function renderPasswordResetEmailHtml(name: string, resetUrl: string): string {
  return `
    <div style="font-family: Inter, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #0F172A;">
...
export function renderSecurityAlertEmailHtml(
  name: string,
  ipAddress: string,
  device: string,
): string {
